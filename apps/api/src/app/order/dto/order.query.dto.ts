...
export class OrderQueryDto {
  ...
  @ValidateOrderPriceFilter()
  @ApiPropertyOptional(
    ApiProp.Num({ ent: Entity.Order, prop: Property.MinPrice })
  )
  ...
  @ValidateOrderPriceFilter()
  @ApiPropertyOptional(
    ApiProp.Num({ ent: Entity.Order, prop: Property.MaxPrice })
  )
