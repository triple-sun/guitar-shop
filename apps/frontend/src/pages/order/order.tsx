        ...
        <div className="container">
          ...
          <ul className="order__list order-list">
            <li className="order-list__item">
              ...
              <span className="order-list__quantity">1</span>
              <span className="order-list__price">17 500 ₽</span>
              <button
            ...
            <li className="order-list__item">
              ...
              <span className="order-list__quantity">2</span>
              <span className="order-list__price">35 000 ₽</span>
              <button
                className="order-list__button button-cross"
                type="button"
                aria-label="Закрыть"
          ...
          <button className="button order__button button--small button--black-border">
