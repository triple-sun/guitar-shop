...
import { fetchCurrentItemAction, fetchCurrentOrderAction } from '@guitar-shop/front/store';
  ...
  return (
    <Routes>
        <Route path={AppRoute.Main}>
          ...
          <Route path={AppRoute.Item} element={<ItemPage />} loader={ ({params}) => dispatch(fetchCurrentItemAction(Number(params.id)))}/>
          <Route path={AppRoute.Orders} element={<OrdersListPage />} />
          <Route path={AppRoute.Order} element={<OrderPage /> } loader={ ({params}) => dispatch(fetchCurrentOrderAction(Number(params.id)))} />
