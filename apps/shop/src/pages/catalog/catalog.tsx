import { CardElement, FiltersComponent, PaginationComponent, PageComponent, FilterPriceComponent, FilterGuitarTypeComponent, FilterStringCountComponent, ItemSortByElement, ItemSortOrderElement } from '@guitar-shop/front/components';
...
export const CatalogPage = () => {
  const {items, sortBy, handleSortByChange, sortOrder, handleSortOrderChange} = useCatalog({forList: true})
    ...
    <div className="container">
      <h1 className="page-content__title title title--bigger">Каталог гитар</h1>
        ...
        <div className="catalog-sort">
          ...
          <ItemSortByElement handleChange={handleSortByChange} sortBy={sortBy}/>
