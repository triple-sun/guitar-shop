...
export * from './lib/configs/mailer.config'
...
export * from './lib/enums/api.enum';
export * from './lib/enums/collection.enum';
export * from './lib/enums/command.enum';
export * from './lib/enums/config.enum';
export * from './lib/enums/env.enum';
export * from './lib/enums/error.enum'
export * from './lib/enums/info.enum'
export * from './lib/enums/mock.enum'
export * from './lib/enums/prefix.enum'
export * from './lib/enums/property.enum'
...
export * from './lib/interfaces/guitar.interface'
