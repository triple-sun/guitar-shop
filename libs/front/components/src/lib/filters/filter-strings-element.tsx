...
export const FilterStringCountElement = ({count}: TFilterStringCountElementProps) => {
  const { handleStringsCountInput, strings } = useCatalog()
  ...
  return (
    <div className="form-checkbox catalog-filter__block-item" key={countType}>
      <input onChange={onTypeInput} className="visually-hidden" type="checkbox" id={countType} name={countType} checked={strings[count]}></input>
